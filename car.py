...
def main(parameters=default_parameters, argv=None, verbose=True):
  ...
  PosscalarEncoderParams.size       = 1000
  PosscalarEncoderParams.sparsity   = parameters["enc"]["value"]["sparsity"]
  PosscalarEncoderParams.resolution = parameters["enc"]["value"]["resolution"]
  PosscalarEncoder = RDSE( PosscalarEncoderParams )
  #Encoder for Velocity
  VelscalarEncoderParams            = RDSE_Parameters()
  VelscalarEncoderParams.size       = 800
  VelscalarEncoderParams.sparsity   = parameters["enc"]["value"]["sparsity"]
  VelscalarEncoderParams.resolution = parameters["enc"]["value"]["resolution"]
  VelscalarEncoder = RDSE( VelscalarEncoderParams )
  #Encoder for Acceleration
  AccscalarEncoderParams            = RDSE_Parameters()
  AccscalarEncoderParams.size       = 1500
  AccscalarEncoderParams.sparsity   = parameters["enc"]["value"]["sparsity"]
  AccscalarEncoderParams.resolution = parameters["enc"]["value"]["resolution"]
  AccscalarEncoder = RDSE( AccscalarEncoderParams )
  #Encoder for Distance
  DisscalarEncoderParams            = RDSE_Parameters()
  DisscalarEncoderParams.size       = 600
  DisscalarEncoderParams.sparsity   = parameters["enc"]["value"]["sparsity"]
  DisscalarEncoderParams.resolution = parameters["enc"]["value"]["resolution"]
  DisscalarEncoder = RDSE( DisscalarEncoderParams )

  #Change
  encodingWidth = (1000+800+1500+600)
