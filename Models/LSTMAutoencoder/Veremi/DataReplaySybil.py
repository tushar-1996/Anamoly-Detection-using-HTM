...
MODEL_LOCATION = 'Models/LSTM__Autoencoder_model_Veremi_NoTIle'
LOG_LOCATION = 'Notebooks/Veremi/DataReplaySybil_0709/'
RESULTS_LOCATION = 'Notebooks/Veremi/DataReplaySybil_0709/'
...
train_features = train_features[train_features['30']==0][[str(i) for i in range(6,33)]].drop(labels='30', axis=1).to_numpy()
...
test_features = test_features[[str(i) for i in range(6,33)]].drop(labels='30', axis=1).to_numpy()
